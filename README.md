...
gradle -PmainClass='edu.colostate.netsec.BgpmonClient' -PmyArgs='open,cassandra,csuadmin,n3ts3c@dmin,129.82.138.74,129.82.138.75' execute
...
gradle -PmainClass='edu.colostate.netsec.BgpmonClient' -PmyArgs='start,prefix-hijack,SESSION1,--file,/home/hamersaw/Downloads/prefix.txt' execute
...
##TODO
implement prefix hijack module
